...
import com.magma.DivingApp.databinding.FragmentDiveRecordsBinding
...
class DiveRecordsFragment:Fragment(),TableClickedInterface {
    private lateinit var binding: FragmentDiveRecordsBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentDiveRecordsBinding.inflate(inflater)
        init()
        ...
        when (dl){
            "0" -> {
                copyAssets("99.pdf").let {
                    Toast.makeText(attachedContext,"Table Sucesfully Downloaded ,check your downloads folder",
